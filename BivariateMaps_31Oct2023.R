...
# Load raster files
#cna_usa <- rast("outputs/rasters/cna_usa_sum_crop.tif") #this is the continuous (0-19) version
cna_usa <- rast("outputs/rasters/cna_usa_90_crop.tif") #this is the binary (0/1) version
...
# double check some layers
plot(pct_pop_species, "acafly", main="Acadian Flycatcher")
